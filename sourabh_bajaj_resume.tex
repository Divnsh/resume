    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Insights Creation Engine}
          {Created backend for generating customizable customer level insights used by store managers for better customer service. Insights include CLTV (Customer Lifetime Value), product recommendations, churn prediction, sentiment analysis, and several non machine learning based insights.}
