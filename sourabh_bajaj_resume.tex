    ...
    \resumeSubheading
      ...
      \resumeItemListStart
		...
		\resumeItem{Segmentation}
		  {Designed and developed an analytics application using Flask API and python. Segments and ranks customers, stores and products based on the features and their priorities selected by the user (K-means and agglomorative hierarchical clustering).}
		\resumeItem{Single View Creator}
		  {Created a customizable customer level single view creator in PySpark for data science applications, significantly increasing the productivity of the team by automating feature engineering on big data.}
